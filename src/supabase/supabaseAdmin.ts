// Copied from:
// https://github.com/vercel/nextjs-subscription-payments/blob/c7867b2d9e08d033056293d12aeb9825b8331806/utils/supabase-admin.ts
// License: MIT
...
const copyBillingDetailsToCustomer = async (
	...
	// @ts-expect-error Null address is fine
	...
	const subscriptionData: Database["public"]["Tables"]["subscriptions"]["Insert"] =
		{
			...
			// @ts-expect-error TODO check quantity on subscription
